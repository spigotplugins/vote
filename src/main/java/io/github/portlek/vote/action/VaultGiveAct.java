...
public final class VaultGiveAct implements Action {

    private final int money;

    public VaultGiveAct(int money) {
        this.money = money;
    }
    ...
    public void save(@NotNull String path, @NotNull IYaml yaml) {
        yaml.set(path + ActionType.VAULT_GIVE.first, money);
    }
    ...
    public List<Placeholder> getPlaceholders() {
        return new ListOf<>(
            new Placeholder("%vault_give%", String.valueOf(money))
        );
    }
